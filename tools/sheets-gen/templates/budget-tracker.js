...
// Pro-only tabs — hidden in Essentials
...
// AI-Edition-only tabs — hidden in Essentials + Pro
...
async function buildBudgetTracker() {
  ...
  // CLI flag: --tier=essentials|pro|ai  (default: ai)
  ...
  const tierTabCount = { essentials: 11, pro: 15, ai: 17 }[tier];
