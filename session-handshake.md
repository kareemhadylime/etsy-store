...
- [ ] **2B remaining** — T105 Meta Marketing Insights, T106 Google (GA4 + Ads + Search Console), T107 TikTok ad metrics. The 3 ad-platform integrations this session was explicitly chartered to build. All parallel.
