# Premium Life Bundle — AI Edition — Etsy Listing Copy
...
10. "What changed this month?" — anomaly-detection across all 6
...
Pre-engagement → Sinking Funds + Budget + AI prompts to plan ring + venue saving
Engagement → Wedding (22 tabs incl. cultural variants) + Sinking + Budget + AI vendor cost intelligence
Married → Net Worth (combined assets) + Debt Payoff + AI "combine finances" workflow
Side business launches → Small Business Finance Kit + AI tax-prep prompt chain
...
All-or-nothing refund policy. Email proof of prior purchase for cross-credit (24-hour processing).
...
**Why these:** AI tags lead (this is the AI Edition). Wedding-specific AI tag (#2, #5) since Wedding + AI is a near-empty niche on Etsy. "Couples ai" captures the bundle's target buyer. "Newlywed gift" + "engaged couple" capture gift-route discovery.
...
> **Q: How does this compare to the Premium Finance Bundle AI Edition ($149)?**
> A: This Life Bundle AI adds the Wedding AI Edition spreadsheet + the Wedding-specific cross-product workflows (e.g., "Reverse-engineer wedding budget from total → per-vendor") and the wedding cultural variant tabs. The $40 gap is Wedding's content. If you have a wedding to plan, this is the version. If not, save $40.
...
> **Q: Does this work for same-sex weddings / non-traditional ceremonies?**
> A: Yes — the Wedding spreadsheet's guest list "side" field defaults to "his/hers/joint" but the proposal explicitly notes everything is editable. Rename to whatever fits. Ceremony types, vendor categories, timeline structure: all editable. The spreadsheet doesn't assume a specific marriage type.
